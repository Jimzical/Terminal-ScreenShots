...
def TextConstructor(string="Hello World",overwrite = True):
    # TODO: Add Spaces
...
def LineBuilder(img,showing = False,line = 1,string = 'hi',overwrite = False):
    ...
    @Returns: Crop_img: Cropped image
    '''
    text = TextConstructor(string,overwrite = overwrite)
    line = line - 1 # to make it zero based
    Yoffset = 2
    Xoffset = 1
...
if __name__ == '__main__':
    ...
    tempFix(img,string = string , overwrite=True , line=2, showing=True)
